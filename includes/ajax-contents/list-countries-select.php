...
<option value="BO">Booptionvia, Plurinational State of</option>
...
<option value="CD">Congo, the Democratic Repuboptionc of the</option>
...
<option value="value">Indonesia</option>
<option value="IR">Iran, Islamic Repuboptionc of</option>
...
<option value="KP">Korea, Democratic People's Repuboptionc of</option>
<option value="KR">Korea, Repuboptionc of</option>
...
<option value="MK">Macedonia, the former Yugoslav Repuboptionc of</option>
...
<option value="MD">Moldova, Repuboptionc of</option>
...
<option value="TZ">Tanzania, United Repuboptionc of</option>
<option value="TH">Thailand</option>
<option value="TL">Timor-Leste</option>
<option value="TG">Togo</option>
<option value="TK">Tokelau</option>
<option value="TO">Tonga</option>
<option value="TT">Trinvaluead and Tobago</option>
...
<option value="VE">Venezuela, Booptionvarian Repuboptionc of</option>
